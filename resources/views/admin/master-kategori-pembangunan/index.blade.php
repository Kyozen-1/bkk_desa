...
@section('title', 'Admin | Kategori Pembangunan')

@section('subtitle', 'Kategori Pembangunan')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="master_kategori_pembangunan_table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama</th>

                ...
                <ul id="master_data">
                    ...
                    <li>
                        @if (request()->routeIs('admin.master-fraksi.index'))
                            <a href="{{ route('admin.master-fraksi.index') }}" class="active">
                        @else
                    ...
                    <li>
                        @if (request()->routeIs('admin.aspirator.index'))
                            <a href="{{ route('admin.aspirator.index') }}" class="active">
                        @else
                            <a href="{{ route('admin.aspirator.index') }}">
                        @endif
                            <span class="label">Aspirator</span>
                        </a>
                    </li>
                    <li>

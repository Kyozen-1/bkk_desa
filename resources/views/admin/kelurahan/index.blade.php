...
<div class="container">
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Kelurahan</h1>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="kelurahan_table" class="data-table nowrap w-100">
                <thead>
                    <tr>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#kelurahan_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
        ...
        $(document).on('click', '.detail', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{ url('/admin/kelurahan/detail') }}"+'/'+id,
                dataType: "json",
        ...
        $('#kecamatan_form').on('submit', function(e){
            ...
            {
                $.ajax({
                    url: "{{ route('admin.kelurahan.store') }}",
                    method: "POST",
                    data: $(this).serialize(),
                    dataType: "json",
                    beforeSend: function()
                    ...
                    success: function(data)
                    {
                        ...
                        if(data.errors)
                        {
                            ...
                            $("[name='kecamatan_id']").val('').trigger('change');
                            $('#aksi_button').text('Save');
                            $('#kelurahan_table').DataTable().ajax.reload();
                        }
                        if(data.success)
                        {
            ...
            {
                $.ajax({
                    url: "{{ route('admin.kelurahan.update') }}",
                    method: "POST",
                    data: $(this).serialize(),
                    dataType: "json",
                    beforeSend: function(){
        ...
        $(document).on('click', '.edit', function(){
            ...
            $('#form_result').html('');
            $.ajax({
                url: "{{ url('/admin/kelurahan/edit') }}"+'/'+id,
                dataType: "json",
                success: function(data)
                {

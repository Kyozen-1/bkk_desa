...
@section('title', 'Admin | Master Tipe Kegiatan')
    ...
    <div class="container">
        ...
        <div class="page-title-container">
            ...
            <div class="col-12 col-md-7">
                <h1 class="mb-0 pb-0 display-4" id="title">Master Tipe Kegiatan</h1>
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                    <ul class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                        <li class="breadcrumb-item"><a href="#">Master Tipe Kegiatan</a></li>
                    </ul>
                </nav>
            </div>
            <!-- Title End -->
        ...
        <div class="data-table-rows slim">
            ...
            <div class="data-table-responsive-wrapper">
                <table id="master_tipe_kegiatan_table" class="data-table nowrap w-100">
                    <thead>
                        <tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="master_tipe_kegiatan_form" class="tooltip-label-end" method="POST" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="mb-3">
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#master_tipe_kegiatan_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.master-tipe-kegiatan.index') }}",
                },
                columns:[
                    {
                        data: 'DT_RowIndex'
        ...
        $(document).on('click', '.detail', function(){
            var id = $(this).attr('id');
            $.ajax({
                url: "{{ url('/admin/master-tipe-kegiatan/detail') }}"+'/'+id,
                dataType: "json",
        ...
        $('#create').click(function(){
            $('#master_tipe_kegiatan_form')[0].reset();
        ...
        $('#master_tipe_kegiatan_form').on('submit', function(e){
            e.preventDefault();
            if($('#aksi').val() == 'Save')
            {
                $.ajax({
                    url: "{{ route('admin.master-tipe-kegiatan.store') }}",
                    method: "POST",
                    ...
                    success: function(data)
                    {
                        ...
                        if(data.errors)
                        {
                            ...
                            $('#aksi_button').prop('disabled', false);
                            $('#aksi_button').text('Save');
                            $('#master_tipe_kegiatan_table').DataTable().ajax.reload();
                        }
                        if(data.success)
                        {
            ...
            {
                $.ajax({
                    url: "{{ route('admin.master-tipe-kegiatan.update') }}",
                    method: "POST",
                    data: new FormData(this),
                    dataType: "json",
                    contentType: false,
        ...
        $(document).on('click', '.edit', function(){
            ...
            $('#form_result').html('');
            $.ajax({
                url: "{{ url('/admin/master-tipe-kegiatan/edit') }}"+'/'+id,
                dataType: "json",
                success: function(data)
                {
        ...
        $(document).on('click', '.delete',function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ url('/admin/master-tipe-kegiatan/destroy') }}" + '/' + id,
                        dataType: "json",
                        beforeSend: function()
                        {
                            return new swal({

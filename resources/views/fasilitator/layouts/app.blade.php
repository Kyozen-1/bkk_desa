...
<head>
	@include('fasilitator.layouts.head')
</head>
...
<body>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<!--navigation-->
			@include('fasilitator.layouts.left-side-menu')
			<!--end navigation-->
		</div>
		<!--end sidebar wrapper -->
		<!--start header -->
				...
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset('images/fasilitator/'.Auth::user()->fasilitator->foto) }}" class="user-img" alt="user avatar">
							<div class="user-info">
								<p class="user-name mb-0">{{Auth::user()->name}}</p>
								<p class="designattion mb-0">Fasilitator</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							<li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('fasilitator.logout') }}">
	...
	@include('fasilitator.layouts.js')
</body>
